    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center justify-between gap-4 mb-6 print:hidden">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={handlePrint}
            className="flex items-center gap-1.5 px-3.5 py-2 bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 text-zinc-200 rounded-lg text-xs font-semibold transition"
          >
      ...
      <div className="bg-white text-zinc-900 rounded-2xl shadow-xl border border-zinc-200 p-8 sm:p-12 space-y-8 font-sans">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 bg-zinc-50 p-5 rounded-xl border border-zinc-200/80 text-xs">
          <div>
            <p className="font-bold text-zinc-500 uppercase tracking-wider mb-1">Billed To (Customer):</p>
            ...
            <p className="text-zinc-500">Pune Tech Park, Maharashtra - 411014</p>
            <p className="text-zinc-500">GSTIN: 27AABCA4412P1ZA</p>
          </div>

          <div>
            <p className="font-bold text-zinc-500 uppercase tracking-wider mb-1">Fulfillment & Dispatch:</p>
        ...
        <div>
          <table className="w-full text-left text-xs">
            <thead>
              <tr className="border-b-2 border-zinc-200 text-zinc-500 font-semibold">
            ...
            <tbody className="divide-y divide-zinc-200">
              {lines.map((l, i) => (
                <tr key={i}>
                  <td className="py-3 font-mono text-zinc-400">{i + 1}</td>
                  <td className="py-3 font-bold text-zinc-900">{l.product?.name}</td>
                  <td className="py-3 text-center font-mono text-zinc-500">84713010</td>
        ...
        <div className="border-t border-zinc-200 pt-6 flex flex-col sm:flex-row justify-between gap-6">
          <div className="text-xs text-zinc-500 space-y-1 max-w-sm">
        ...
        {/* Signoff */}
        <div className="border-t border-zinc-100 pt-6 flex items-center justify-between text-xs text-zinc-400">
