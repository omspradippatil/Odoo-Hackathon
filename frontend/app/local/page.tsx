...
export default function LocalModeHome() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="rounded-2xl bg-gradient-to-r from-blue-950/70 via-indigo-950/40 to-zinc-900 border border-blue-900/40 p-6 sm:p-8 mb-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-xl">
        <div className="space-y-2 max-w-2xl">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-blue-500/20 border border-blue-500/30 text-blue-400 text-xs font-bold">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-8">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 bg-zinc-900 border border-zinc-800 rounded-xl text-xs text-zinc-200 placeholder-zinc-500 focus:outline-none focus:border-blue-500 transition"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {filteredProducts.map((p) => {
          ...
          return (
            <div
              key={p.id}
              className="bg-zinc-900/50 border border-zinc-800/80 hover:border-zinc-700 rounded-xl p-5 flex flex-col justify-between transition shadow-sm group"
            >
              <div>
                ...
                <h3 className="font-bold text-base text-zinc-100 group-hover:text-blue-400 transition mb-1">
                  {p.name}
                </h3>
              ...
              <div className="pt-4 border-t border-zinc-800/80 flex items-center justify-between">
                <div>
                  <p className="text-[10px] text-zinc-500 uppercase font-semibold">Listed Price</p>
