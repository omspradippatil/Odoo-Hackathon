    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-gray-200 mb-8">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/local"
            className="px-3.5 py-2 bg-gray-50 border border-gray-200 hover:bg-gray-100 text-zinc-200 rounded-lg text-xs font-semibold transition"
          >
            View Live Shopfront
          </Link>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="bg-gray-50/50 border border-gray-200 p-5 rounded-xl">
          ...
          <p className="text-2xl font-black text-gray-800 font-mono">{products.length}</p>
          <p className="text-[10px] text-gray-9000 mt-1">Listed across electronics & accessories</p>
        </div>
        ...
        <div className="bg-gray-50/50 border border-gray-200 p-5 rounded-xl">
          ...
          <p className="text-[10px] text-gray-9000 mt-1">Based on 42 verified local trades</p>
        </div>
        ...
        <div className="bg-gray-50/50 border border-gray-200 p-5 rounded-xl">
          ...
          <p className="text-[10px] text-gray-9000 mt-1">Releasing upon delivery proof</p>
        </div>
      ...
      <div className="bg-gray-50/50 border border-gray-200 rounded-xl p-5">
        <h2 className="text-sm font-bold text-zinc-200 mb-4 flex items-center justify-between">
          ...
          <span className="text-xs text-gray-500 font-normal">Auto-synced with PostgreSQL database</span>
        </h2>
            ...
            <tbody className="divide-y divide-zinc-800/60">
              {products.map((p) => (
                <tr key={p.id} className="hover:bg-gray-50/40">
                  ...
                  <td className="py-3 text-gray-500">{p.category?.name || "General"}</td>
                  <td className="py-3 font-mono font-bold text-gray-800">
